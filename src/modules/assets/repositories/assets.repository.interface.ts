...
export interface AssetsRepository {
  ...
  findAssetById(householdId: string, assetId: string): Promise<Asset | undefined>;
  insertAsset(asset: Asset): Promise<void>;
  updateAsset(assetId: string, asset: Asset): Promise<void>;
  deleteAsset(assetId: string): Promise<void>;
  findAssetValuations(householdId: string, assetId: string): Promise<AssetValuation[]>;
  findAssetValuation(assetId: string, valuationDate: string): Promise<AssetValuation | undefined>;
